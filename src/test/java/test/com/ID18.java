...
public class ID18 {
    ...
    element4.click();   
     ...
     // click on Plan Details: Supplemental Life and AD&D
    WebElement element5=driver.findElement(By.xpath("//*[@id=\"dvMyPlansBody\"]/div/div[2]/div[5]/div/app-my-plan-item/div/div/button"));  
    ...
    WebElement element6=driver.findElement(By.xpath("/html/body/app-root/ng-component/app-modal/div/app-plan-detail/div/div/div[3]/div[2]/ul/li[2]/a"));
    driver.manage().timeouts().implicitlyWait(110, TimeUnit.SECONDS);
    element6.click();

    // Assertion
    String actualString = driver.findElement(By.xpath("//*[@id=\"planInfo\"]/div/div/table/tbody/tr[8]/td[1]/div")).getText();
    assertTrue(actualString.contains("AD&D Schedule of Benefits"));

...
public class ID16 {
    ...
    element4.click();   
     ...
     // click on Plan Details: Health Care FSA
    WebElement element5=driver.findElement(By.xpath("//*[@id=\"dvMyPlansBody\"]/div/div[2]/div[3]/div/app-my-plan-item/div/div/button"));  
    ...
    assertTrue(actualString.contains("Important Spending Account Information"));

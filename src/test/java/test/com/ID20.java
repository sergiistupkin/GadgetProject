...
public class ID20 {
    ...
    element4.click();   
     ...
     // click on Plan Details: Supplemental Dependent Life
    WebElement element5=driver.findElement(By.xpath("//*[@id=\"dvMyPlansBody\"]/div/div[2]/div[7]/div/app-my-plan-item/div/div/button"));  
    ...
    // Assertion
    String actualString = driver.findElement(By.xpath("//*[@id=\"planInfo\"]/div/div/table/tbody/tr[1]/th[2]/span")).getText();
    assertTrue(actualString.contains("Important Dependent Life Information"));

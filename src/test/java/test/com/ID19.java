...
public class ID19 {
    ...
    element4.click();   
     ...
     // click on Plan Details: Supplemental Spouse Life
    WebElement element5=driver.findElement(By.xpath("//*[@id=\"dvMyPlansBody\"]/div/div[2]/div[6]/div/app-my-plan-item/div/div/button"));  
    ...
    // Assertion
    String actualString = driver.findElement(By.xpath("//*[@id=\"planInfo\"]/div/div/table/tbody/tr[5]/td[1]/div")).getText();
    assertTrue(actualString.contains("Portability and Conversion"));

...
public class ID15 {
    ...
    element4.click();   
     ...
     // click on Plan Details: Dental PPO Plan
    WebElement element5=driver.findElement(By.xpath("//*[@id=\"dvMyPlansBody\"]/div/div[2]/div[2]/div/app-my-plan-item/div/div/button"));  
    ...
    assertTrue(actualString.contains("X-Rays"));
